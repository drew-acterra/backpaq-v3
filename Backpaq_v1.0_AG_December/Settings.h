 ...
 */
  ...
  #warning "Custom board configuration is used" // WHAT WE DO HERE: "27" is NeoPixel pin, "33" is reset button pin
...
#define BUTTON_HOLD_TIME_ACTION       10000 // hold down for 10 seconds to initiate reset
